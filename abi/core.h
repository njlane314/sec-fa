...
typedef enum fa_metric_id {
    ...
    FA_METRIC_CASH = 7,
    FA_METRIC_DEBT = 8,
    FA_METRIC_GROSS_PROFIT = 9,
    FA_METRIC_OPERATING_INCOME = 10,
    FA_METRIC_RESEARCH_AND_DEVELOPMENT = 11,
    FA_METRIC_STOCK_BASED_COMPENSATION = 12,
    FA_METRIC_INTEREST_EXPENSE = 13,
    FA_METRIC_BUYBACKS = 14
} fa_metric_id;
...
typedef enum fa_basis_id {
    ...
    FA_BASIS_GROSS_PROFIT_STANDARD = 901,
    FA_BASIS_OPERATING_INCOME_STANDARD = 1001,
    FA_BASIS_RESEARCH_AND_DEVELOPMENT_STANDARD = 1101,
    FA_BASIS_STOCK_BASED_COMPENSATION_STANDARD = 1201,
    FA_BASIS_STOCK_BASED_COMPENSATION_ALLOCATED = 1202,
    FA_BASIS_INTEREST_EXPENSE_NONOPERATING = 1301,
    FA_BASIS_INTEREST_EXPENSE_STANDARD = 1302,
    FA_BASIS_INTEREST_EXPENSE_DEBT = 1303,
    FA_BASIS_BUYBACKS_CASH_PAID = 1401,
    FA_BASIS_BUYBACKS_RETIRED_VALUE = 1402,
    FA_BASIS_BUYBACKS_REPURCHASED_VALUE = 1403
} fa_basis_id;
...
typedef enum fa_statement_quality_flag {
    ...
    FA_STMT_MISSING_OPERATING_CASH_FLOW = 1u << 8,
    FA_STMT_MISSING_CAPEX = 1u << 9,
    FA_STMT_DERIVED_TTM = 1u << 10
...
typedef struct fa_statement_build_output_v1 {
    uint32_t abi_version;
    size_t statement_count;
    fa_statement_snapshot_v1* statements;
...
fa_status_code fa_build_portfolio_plan_v1(
...
void fa_statement_build_output_free_v1(fa_statement_build_output_v1* output);

fa_status_code fa_build_valuation_plan_v1(
